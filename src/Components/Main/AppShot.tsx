...
const AppShot = () => {
    ...
    return (
        <Box className='relative align-center justify-center h-200 w-90 flex mx-auto mt-12'>
            <img src={Screenshot9} alt="App Screenshot" className='rounded-2xl object-cover h-200 w-80' />
